...
echo "Note: progressive.jpg and cmyk.jpg are committed and regenerated only manually with:"
echo "magick crates/core/tests/fixtures/sample.jpg -resize 96x72 -interlace JPEG -quality 85 crates/core/tests/fixtures/progressive.jpg"
echo "magick crates/core/tests/fixtures/sample.jpg -resize 96x72 -colorspace CMYK -quality 85 crates/core/tests/fixtures/cmyk.jpg"
